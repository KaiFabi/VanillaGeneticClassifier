...
The resulting graphs show the loss and accuracy for the evaluation dataset of the MNIST and Fashion-MNIST dataset for different combinations of local and global mutation rates (`mut_loc | mut_glb`).
